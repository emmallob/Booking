                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Account Verification</h3></div>
                                    <div class="card-body">
                                        ...
                                        print_msg("danger", "Sorry! An invalid activation code was submitted. Confirm and try again.");
                                    }
                                        ?>
