...
function subscription_error() {
	print '<div class="row justify-content-center">
		<div class="col-lg-12 col-md-8 col-sm-12" style="border-radius: 0px">
			<div class="alert alert-danger text-center">
				Sorry! Your current subscription does not grant you permission to perform this action.
			</div>
		</div>
	</div>';
}
	...
	return '<div class="row justify-content-center">
			<div class="col-lg-12">
				<div class="text-center mt-4">
					...
					<p class="lead">This requested item was not found on this server.</p>
...
function no_data_to_display($title = "No data to Show at the Moment", $button = '<div>Please come back later as we fetch data that recorrespond to this metric.</div>') {
	return '<div class="row">
			<div class="col-lg-12 no-data-found">
				<div class="no-data-content text-center" style="width:100%">
					<i class="fa fa-4x text-success fa-file-archive-o"></i>
					<p>'.$title.'</p>
					'.$button.'
				</div>
			</div>    
